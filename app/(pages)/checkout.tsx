...
import { getShippingAddresses, saveShippingAddress } from "@/services/addressService";
                        ...
                        <View className="space-y-3">
                            {deliveryOptions.map((option) => (
                                <TouchableOpacity
                                    ...
                                    className={`border rounded-xl p-4 ${selectedDeliveryOption === option.id
                                ...
                                >
                                    <View className="flex-row items-center justify-between mb-2">
                                        <View className="flex-row items-center">
                                            <View className={`w-5 h-5 rounded-full border-2 mr-3 ${selectedDeliveryOption === option.id
                                                ? 'border-purple-500 bg-purple-500'
                                                : 'border-gray-300'
                                                }`}>
                                            ...
                                            <View>
                                                <Text className={`font-semibold ${selectedDeliveryOption === option.id ? 'text-purple-900' : 'text-gray-900'
                                                    }`}>
                                                    {option.title}
                                                </Text>
                                                <Text className={`text-sm ${selectedDeliveryOption === option.id ? 'text-purple-700' : 'text-gray-600'
                                                    }`}>
                                                    {option.subtitle}
                                                </Text>
                                            </View>
                                        ...
                                        <View className="items-end">
                                            <Text className={`font-bold ${selectedDeliveryOption === option.id ? 'text-purple-900' : 'text-gray-900'
                                                }`}>
                                    ...
                                    <View className="flex-row items-center mt-2">
                                        ...
                                        />
                                        <Text className={`text-xs ml-1 ${selectedDeliveryOption === option.id ? 'text-purple-700' : 'text-gray-500'
                                            }`}>
